 ...
 */
public abstract class RecordsAdapterOld extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = RecordsAdapterOld.class.getCanonicalName();
